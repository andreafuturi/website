...
function u(e, t2, n2, o2, i2, u2) {
  ...
  var p2 = { type: e, props: l3, key: n2, ref: a2, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --f, __i: -1, __u: 0, __source: i2, __self: u2 };
...
function p(e, t2) {
  ...
  if ("style" === e && "object" == typeof t2) {
    ...
    for (var u2 in t2) {
      var a2 = t2[u2];
      if (null != a2 && "" !== a2) {
        var p2 = "-" == u2[0] ? u2 : c[u2] || (c[u2] = u2.replace(l2, "-$&").toLowerCase()), s2 = ";";
        "number" != typeof a2 || p2.startsWith("--") || o.test(p2) || (s2 = "px;"), i2 = i2 + p2 + ":" + a2 + s2;
      }
    }
    return e + '="' + i2 + '"';
  }
...
//# sourceMappingURL=chunk-4E2TCACK.js.map
